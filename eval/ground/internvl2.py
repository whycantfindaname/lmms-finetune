...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='results/gvlmiqa_bench/internvl2/internvl2_gvlmiqav2-ground-train.json', help='path to save the predicted answers')
