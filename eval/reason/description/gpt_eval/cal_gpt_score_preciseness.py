...
if __name__ == "__main__":
    ...
    for idx_meta, (golden_item, desp_item) in enumerate(zip(golden_data[idx_meta_start:idx_meta_end], save_data[idx_meta_start:idx_meta_end])):
        ...
        system_prompt = (
            ...
            + "question-answer pairs. Focus on whether the MLLM description [MLLM DESC] precisely reflects the key low-level visual details "
        ...
        try:
            ...
            content = gpt4o(img_path, system_prompt, preciseness_query)
