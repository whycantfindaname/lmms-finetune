...
if __name__ == "__main__":
    ...
    for idx_meta, (golden_item, desp_item) in enumerate(zip(golden_data[idx_meta_start:idx_meta_end], save_data[idx_meta_start:idx_meta_end])):
        ...
        system_prompt = (
            ...
            + "description. Focus on whether the MLLM description [MLLM DESC] accurately includes the key low-level visual details "
        ...
        try:
            ...
            import re
            content = gpt4o(img_path=None, system_prompt=system_prompt, query=completeness_query)
