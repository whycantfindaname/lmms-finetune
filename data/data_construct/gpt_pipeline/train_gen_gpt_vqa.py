...
parser.add_argument("--vqa_file", type=str, default='data/meta_json/train/test/test_vqa_v1.json')
    ...
    for idx_meta, meta_item in enumerate(meta_data[idx_meta_start:]):
        ...
        try:
            ...
            system_prompt_assess_data = (
                ...
                + " 5. The total number of generated questions should be less than 15.\n"
