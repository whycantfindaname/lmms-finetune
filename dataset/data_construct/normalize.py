...
# 设置路径
json_file_path = 'dataset/meta_json/benchmark/benchmark_2k_seagull_cleaned.json'  # 原始 JSON 文件路径
image_folder = '/mnt/bn/lwj/datasets/gvlmiqa_bench'
output_file_path = 'dataset/meta_json/benchmark/benchmark_2k_normalized_seagull_cleaned.json'  # 输出 JSON 文件路径
os.remove(output_file_path)
log_file_path = 'dataset/normalization_log.txt'  # 日志文件路径
