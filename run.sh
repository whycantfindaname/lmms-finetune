...
#SBATCH --output=/home/u9920230028/lmms-finetune-main-v1/testbug/inference_job_output.txt
#SBATCH --error=/home/u9920230028/lmms-finetune-main-v1/testbug/inference_job_error.txt
...
# according to your own case
MODEL_ID=llava-interleave-qwen-7b   # model id or path; pick on by running `python supported_models.py`
MODEL_PATH=./models/llava-interleave-qwen-7b
TRAIN_DATA_PATH=./dataset/json_v1/train_data.json # path to the training data json file
EVAL_DATA_PATH=./dataset/json_v1/val_data.json   # path to the evaluation data json file (optional)
IMAGE_FOLDER=./dataset/images_v1                  # path to the image root folder; if provided, the image paths in the json should be relative
