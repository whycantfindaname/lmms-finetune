...
TRAIN_DATA_PATH=../datasets/llava/score/llava_score.json  # path to the training data json file
EVAL_DATA_PATH=../gen_prompt/dataset/clean_data_v1/score/onealign_11656_val.json  # path to the evaluation data json file (optional)
...
RUN_ID=${MODEL_ID}_lora-${USE_LORA}_qlora-${Q_LORA}-gvlmiqa-v0.2_score    # a custom run id that determines the checkpoint folder and wandb run name
